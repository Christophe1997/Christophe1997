...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 1.8B (-52%)   Cost: $562.65 (-52%)   Streak: 0 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 1.8B (-52%)   Cost: $562.65 (-52%). Streak: 0 days." width="100%"></picture>
