...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 4.8B (+251%)   Cost: $1654.82 (+35%)   Streak: 0 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 4.8B (+251%)   Cost: $1654.82 (+35%). Streak: 0 days." width="100%"></picture>
