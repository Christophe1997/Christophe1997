...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 2.6B (+118%)   Cost: $1198.38 (+9%)   Streak: 1 day</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 22 days. Tokens: 2.6B (+118%)   Cost: $1198.38 (+9%). Streak: 1 day." width="100%"></picture>
