...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.4B (-41%)   Cost: $1120.95 (-37%)   Streak: 1 day</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.4B (-41%)   Cost: $1120.95 (-37%). Streak: 1 day." width="100%"></picture>
