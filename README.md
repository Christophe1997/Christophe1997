...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 5.5B (+263%)   Cost: $1701.79 (+49%)   Streak: 3 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 5.5B (+263%)   Cost: $1701.79 (+49%). Streak: 3 days." width="100%"></picture>
