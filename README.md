...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.8B (+214%)   Cost: $1538.90 (+41%)   Streak: 4 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.8B (+214%)   Cost: $1538.90 (+41%). Streak: 4 days." width="100%"></picture>
