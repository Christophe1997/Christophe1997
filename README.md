...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.9B (-8%)   Cost: $1255.47 (-27%)   Streak: 4 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.9B (-8%)   Cost: $1255.47 (-27%). Streak: 4 days." width="100%"></picture>
