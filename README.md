...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 5.2B (+285%)   Cost: $1778.07 (+49%)   Streak: 2 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 5.2B (+285%)   Cost: $1778.07 (+49%). Streak: 2 days." width="100%"></picture>
