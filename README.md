...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 2.7B (-27%)   Cost: $854.96 (-27%)   Streak: 3 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 2.7B (-27%)   Cost: $854.96 (-27%). Streak: 3 days." width="100%"></picture>
