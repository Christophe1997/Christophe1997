...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.5B (+193%)   Cost: $1468.21 (+34%)   Streak: 4 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.5B (+193%)   Cost: $1468.21 (+34%). Streak: 4 days." width="100%"></picture>
