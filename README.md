...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 4.6B (+62%)   Cost: $1452.15 (+14%)   Streak: 2 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 4.6B (+62%)   Cost: $1452.15 (+14%). Streak: 2 days." width="100%"></picture>
