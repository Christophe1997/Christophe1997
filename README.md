...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 5B (+112%)   Cost: $1499.04 (+7%)   Streak: 5 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 5B (+112%)   Cost: $1499.04 (+7%). Streak: 5 days." width="100%"></picture>
