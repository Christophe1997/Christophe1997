...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 5.2B (+163%)   Cost: $1563.07 (+18%)   Streak: 4 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 5.2B (+163%)   Cost: $1563.07 (+18%). Streak: 4 days." width="100%"></picture>
