...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.7B (-9%)   Cost: $1166.56 (-28%)   Streak: 1 day</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.7B (-9%)   Cost: $1166.56 (-28%). Streak: 1 day." width="100%"></picture>
