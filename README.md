...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 3.6B (-11%)   Cost: $1138.49 (-30%)   Streak: 0 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 3.6B (-11%)   Cost: $1138.49 (-30%). Streak: 0 days." width="100%"></picture>
