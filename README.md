...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 2.5B (+149%)   Cost: $1401.79 (+62%)   Streak: 4 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 2.5B (+149%)   Cost: $1401.79 (+62%). Streak: 4 days." width="100%"></picture>
