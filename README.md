...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 5B (+274%)   Cost: $1731.53 (+45%)   Streak: 2 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 5B (+274%)   Cost: $1731.53 (+45%). Streak: 2 days." width="100%"></picture>
