...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 4.6B (+81%)   Cost: $1371.73 (+17%)   Streak: 1 day</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 4.6B (+81%)   Cost: $1371.73 (+17%). Streak: 1 day." width="100%"></picture>
