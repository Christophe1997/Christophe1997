...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 4.1B (-21%)   Cost: $1327.96 (-25%)   Streak: 5 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 30 days. Tokens: 4.1B (-21%)   Cost: $1327.96 (-25%). Streak: 5 days." width="100%"></picture>
