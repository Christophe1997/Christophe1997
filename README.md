...
<!-- token-profile:start -->
<details open>
<summary>Token Profile — Tokens: 2.1B (+153%)   Cost: $1351.71 (+89%)   Streak: 3 days</summary>

<picture><source media="(prefers-color-scheme: dark)" srcset=".token-profile/card-dark.svg"><img src=".token-profile/card-light.svg" alt="Token Profile — last 31 days. Tokens: 2.1B (+153%)   Cost: $1351.71 (+89%). Streak: 3 days." width="100%"></picture>
